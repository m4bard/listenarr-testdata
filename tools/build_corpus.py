...
SEEDS: list[tuple[str, str, str, list[str]]] = [
    ...
    ("B01FKWL15A", "Verne", "Twenty Thousand Leagues", ["work-key", "numeral"]),
    ("B076HSP1FT", "Verne", "20,000 Leagues", ["work-key", "numeral"]),
    ("B007BR5KZA", "Baum", "Wonderful Wizard", ["work-key", "series"]),
    ("B002V5CJM4", "Baum", "Wonderful Wizard", ["work-key", "series"]),
    ...
    ("B004YWTD30", "Haggard", "History of Adventure", ["title-collision", "subtitle"]),
    ("B0096QR7Z0", "Haggard", "Allan Quatermain", ["title-collision"]),
    ("B002UZKHRE", "Haggard", "Marie", ["title-collision", "series-order"]),
    ("B00OQQTXE8", "Kipling", "The Jungle Book", ["title-collision", "series"]),
    ("B01JWOHBEC", "Kipling", "Second Jungle Book", ["title-collision", "series"]),
    ("B002V1OVFQ", "Burroughs", "Pellucidar", ["title-collision"]),
    ("B0C6B525PQ", "Burroughs", "Tanar", ["title-collision"]),
    ("B002V5B7TK", "Burroughs", "Tarzan of the Apes", ["title-collision", "series"]),
    ("B01GIO3GFW", "Burroughs", "Return of Tarzan", ["title-collision", "series"]),
    ...
    ("B084J9S79P", "Barrie", "Peter and Wendy", ["title-collision", "author-variant", "series"]),
    ...
    ("B0DKK1PKN7", "Verne", "Around the Moon", ["title-variant"]),
    ("B073JR7W68", "Montgomery", "Green Gables", ["series", "author-variant"]),
    ("B002V8L2UQ", "Montgomery", "Avonlea", ["series", "author-variant"]),
    ("B07TKCFMD1", "Lofting", "Story of Doctor Dolittle", ["series"]),
    ("B002V8OEG0", "Lofting", "Voyages of Doctor Dolittle", ["series"]),
    ...
    ("B0F48KS3BX", "Verne", "Vingt mille lieues", ["non-english", "multi-asin"]),
    ("B008WB1L70", "Verne", "Vingt mille lieues", ["non-english", "abridged", "multi-asin"]),
    ("B008Q3A6JI", "Verne", "Vingt mille lieues", ["non-english", "full-cast", "multi-asin"]),
    ("B0DY31J772", "Verne", "Vingt mille lieues", ["cross-region-language", "multi-asin"]),
    ("B00TPW1FLM", "Kafka", "Verwandlung", ["non-english", "multi-asin"]),
    ("B00TDZQG3I", "Kafka", "Verwandlung", ["non-english", "multi-narrator", "multi-asin"]),
    ("B01LFD0GWM", "Kafka", "The Metamorphosis", ["multi-asin"]),
    ("B01MU7YH84", "Kafka", "Metamorphosis", ["full-cast", "multi-asin"]),
    ("B00B4FPVR2", "Grimm", "schönsten Kinder", ["non-english", "region-lock", "multi-asin"]),
    ("B00UXEBBIS", "Grimm", "Sämtliche", ["non-english", "multi-asin"]),
    ("B00TPKF9QQ", "Grimm", "Dornröschen", ["non-english", "multi-asin"]),
    ("B00T9V0BU0", "Grimm", "schönsten Märchen", ["non-english", "multi-asin"]),
    ("B00EOO99WS", "Goethe", "Faust", ["non-english", "multi-asin"]),
    ("B0DZXWPQNW", "Goethe", "komplette Hörbuch", ["non-english", "multi-asin"]),
    ("B00JQEQFL4", "Goethe", "Faust", ["non-english", "abridged", "multi-asin"]),
    ("B00APWL9E4", "Goethe", "Faust", ["non-english", "abridged", "multi-asin"]),
    ("B01IDLCAMI", "Goethe", "Faust I + II", ["non-english", "abridged", "multi-asin"]),
    ("B004V5UU0A", "Goethe", "Weltliteratur", ["non-english", "multi-asin"]),
    ("B0B1QKNWH3", "Goethe", "Tragödie Erster Teil", ["non-english", "radio-play", "multi-asin"]),
    ("B0899BQL13", "Goethe", "Faust 1", ["non-english", "full-cast", "multi-asin"]),
    ("B08SQ3S34B", "Goethe", "Faust 2", ["non-english", "full-cast", "multi-asin"]),
    ...
    ("B003F6JXC2", "Dante", "Divina Commedia", ["non-english", "multi-asin"]),
    ("B07B7MCLB3", "Dante", "Inferno", ["non-english", "multi-asin"]),
    ("B07RGRBKS5", "Dante", "Divina Comedia", ["non-english", "title-one-letter-apart"]),
